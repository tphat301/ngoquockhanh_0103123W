                ...
                <div class="box-product" data-aos="fade-up" data-aos-duration="1000">
                    <p class="pic-product">
                        <a class="text-decoration-none scale-img" href="<?= $v[$sluglang] ?>" title="<?= $v['name' . $lang] ?>">
                            <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/386x258x1/assets/images/noimage.png';" data-src="<?= THUMBS ?>/386x258x1/<?= UPLOAD_PRODUCT_L . $v['photo'] ?>" alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" />
                        </a>
                    </p>
                    <h3>
