...
/* Slogan tin tức */
$nametype = "slogan-tin-tuc";
$config['static'][$nametype]['title_main'] = "Slogan tin tức";
$config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['static'][$nametype]['name'] = true;

/* Slogan sản phẩm nổi bật */
$nametype = "slogan-spnb";
$config['static'][$nametype]['title_main'] = "Slogan sản phẩm nổi bật";
$config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['static'][$nametype]['name'] = true;

/* Slogan tiêu chí */
$nametype = "slogan-tieu-chi";
